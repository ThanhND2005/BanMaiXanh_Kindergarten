...
const notifications = [
  {
    ...
    senderName:'Admin',
    title:'Lịch nghỉ tết',
    content: "Kính gửi các phụ huynh, lịch nghỉ tết của chúng ta sẽ bắt đầu tự ngày 31/12 cho tới 2/1 nhé.",
  ...
  },
  {
    ...
    senderName:'Vân Anh',
    title:'Lưu ý',
    content: "Phụ huynh ơi, dạo này em thấy bé nhà mình có dấu hiệu chán ăn, phụ huynh lưu ý nhé",
    createdat: '30/12/2025'
  },
