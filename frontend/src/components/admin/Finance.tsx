      ...
      <div className='grid grid-cols-2 gap-8 p-4'>
        ...
        <div className='bg-[#ffffff] rounded-xl shadow-md flex justify-between p-6'>
          <div className='gap-3 justify-start'>
            ...
            <h1 className='text-4xl font-bold mt-4 flex justify-start'>{teacherbills?.filter(teacherbill => teacherbill.status !== null && teacherbill.month === new Date().getMonth()).length}</h1>
          </div>  
          <div className='flex justify-end items-center'>
