...
import { deleteStudent, deleteTeacher, getMenu, getNotificationList, getTeacherList, patchStudent, patchTeacher, postCheckin, postCheckout, postNotification, postTimeKeeping, verifyTeacherBill,patchAvatar } from '~/controllers/teacherControllers'
